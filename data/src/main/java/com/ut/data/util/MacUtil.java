...
/**
 * Created by huangkaifan on 2018/5/31.
 */

public class MacUtil {


    public static byte[] getMacByte(Context context) {
        byte[] srcMac = new byte[6];
        String[] tmp = MacUtil.getMac(context).split(":");
        for(int i=0; i<tmp.length; i++) {
            srcMac[i] = (byte) Integer.parseInt(tmp[i], 16);
//            System.out.printf(Integer.toHexString(srcMac[i] & 0xff) + " ");
        }
